    ...
    <div className="home-page">
      ...
      >
        ...
        <div className="steps-container">
          {[
            { number: '01', title: 'Create an account', description: 'Sign up in seconds and set your health goals' },
            { number: '02', title: 'Log your meals', description: 'Easily record what you eat throughout the day' },
            { number: '03', title: 'Track progress', description: 'Monitor your nutrition and achieve your goals' }
          ].map((step, index) => (
            <motion.div 
              className="step-card"
              key={index}
